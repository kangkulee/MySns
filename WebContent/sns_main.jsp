	...
	function newuser() {
		window
				.open(
						"new_user.jsp",
						"newuser",
						"titlebar=no,location=no,scrollbars=no,"
								+ "resizeable=no,menubar=no,toolbar=no,width=300,height=240");
	}
</script>
</head>
<body>
	...
	<div id="wrapper">
		<section id="main">
			<section id="content">
				...
				<h3>친구들의 최신 소식</h3>
				<div id="accordion">
					<c:forEach varStatus="mcnt" var="msgs" items="${dataList}">
